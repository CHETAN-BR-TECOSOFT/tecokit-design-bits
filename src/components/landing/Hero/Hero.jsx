      ...
      {!isMobile && (
        <div className="hero-cards-container">
          <div
            ...
            onClick={() =>
              window.open("https://tecokit.com/backgrounds/dot-grid")
            }
          >
          ...
          <div className="hero-cards-row">
            <div
              ...
              onClick={() =>
                window.open("https://tecokit.com/backgrounds/letter-glitch")
              }
            >
              <LetterGlitch
            ...
            <div
              ...
              onClick={() =>
                window.open("https://tecokit.com/backgrounds/squares")
              }
            >
              <Squares
                borderColor="#fff"
