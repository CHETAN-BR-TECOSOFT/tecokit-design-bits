  ...
  const tweets = [
    ...
    },
    {
      ...
      avatar: 'https://pbs.twimg.com/profile_images/1722358890807861248/75S7CB3G_400x400.jpg',
              text: 'TecoKit: Design Bits: A stellar collection of React components to make your landing pages shine ✨',
      handle: '@gregberge_',
    ...
    },
    {
      ...
      avatar: 'https://pbs.twimg.com/profile_images/1880284612062056448/4Y2C8Xnv_400x400.jpg',
              text: 'Have you heard of TecoKit: Design Bits? David Haz has lovingly put together a collection of animated and fully customizable React components.',
      handle: '@DIYDevs',
    ...
    },
    {
      ...
      avatar: 'https://pbs.twimg.com/profile_images/1724192049002340352/-tood-4D_400x400.jpg',
              text: 'TecoKit: Design Bits has got to be the most artistic ui component lib I have seen in a while 🤌',
    ...
    },
    {
      ...
      avatar: 'https://pbs.twimg.com/profile_images/1885430699567513600/JP1m8cHY_400x400.jpg',
              text: 'This React library is absolutely amazing!!! TecoKit: Design Bits is packed with animated components that make building creative and interactive websites so much easier.',
      handle: '@Traccey001',
      ...
      <div className="testimonials-container">
        <div className="testimonials-header">
          ...
          <p className="testimonials-subtitle">
            See what developers are saying about TecoKit: Design Bits
          </p>
        </div>
