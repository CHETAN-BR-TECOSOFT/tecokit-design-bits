  ...
  return (
    <>
      <section className="showcase-wrapper">
        <title>TecoKit: Design Bits - Showcase 🎉</title>

        <div className="showcase-header">
          <h1 className="showcase-title">Community Showcase</h1>
                      <p className="showcase-subtitle">See how developers around the world are using TecoKit: Design Bits in their projects</p>
          ...
          <div className="grid-container">
            {showcaseItems.map((item, index) =>
              <Box as="a" href={item.url} rel="noreferrer" target="_blank" className="grid-item" key={item.url}>
                <img className="showcase-img" src={`https://davidhaz.com/tecokit-design-bits-showcase/showcase-${index + 1}.webp`} alt={`Showcase website submitted by: ${item.name ? item.name : 'Anonymous'}`} />
